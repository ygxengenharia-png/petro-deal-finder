          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5 flex-wrap mb-1.5">
                    <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-info/15 text-info border border-info/30">
                      Op. {o.opportunityNumber}
                    </span>
              ...
              <div className="border-t border-border pt-2 flex items-end justify-between">
                ...
                <div
                  className={`text-xs font-semibold ${margin >= 0 ? "text-success" : "text-destructive"}`}
                >
                  {margin.toFixed(1)}%
                </div>
              </div>
